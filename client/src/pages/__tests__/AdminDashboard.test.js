...
describe('AdminDashboard document title', () => {
  beforeEach(() => {
    axios.get.mockReset();
    localStorage.clear();
  ...
  it('sets the document title to Admin Dashboard', async () => {
    render(
      <AuthProvider>
        <AlertProvider>
          <MemoryRouter>
    ...
    expect(document.title).toBe('Admin Dashboard | AI/ML Career Forum');
  });
});
